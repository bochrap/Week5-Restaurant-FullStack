...
db.exec(`
    ...
    ('Shepherds Pie', 'Ground lamb cooked with vegetables, topped with mashed potatoes', '10.99', 'mains','./client/menu-imgs/shepherdspie_2077_16x9.jpg'),
    ...
    ('Ploughmans Platter', 'Assorted cheeses, pickles, and bread with butter',  '8.99', 'sides','./client/menu-imgs/ploughmansplatter.jpg'),
